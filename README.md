...
- Public leaderboard (separate project)
...
- **No leaderboard.** v0.1.1 does not include a leaderboard. Leaderboard is a separate future project.
- **Reasoning not scored.** Reasoning text is captured but not graded in v0.1.1. Grading reasoning reliably requires human labels or a judge model — planned for v0.2.
